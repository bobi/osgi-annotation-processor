...
public abstract class JpsBuildTestCase extends UsefulTestCase {
    ...
    protected JpsSdk<JpsDummyElement> addJdk(final String name) {
        try {
            ...
            String path = pathToRtJar == null
                          ? null
                          : FileUtil.toSystemIndependentName(new File(pathToRtJar).getCanonicalPath());
    ...
    protected JpsSdk<JpsDummyElement> addJdk(final String name, @Nullable String jdkClassesRoot) {
        ...
        JpsTypedLibrary<JpsSdk<JpsDummyElement>> jdk = myModel.getGlobal()
    ...
    protected void loadProject(String projectPath,
        ...
        try {
            ...
            String fullProjectPath = FileUtil.toSystemDependentName(testDataRootPath != null
                                                                    ? testDataRootPath + "/" + projectPath
                                                                    : projectPath);
    ...
    public void checkFullLog(File expectedLogFile) {
        assertSameLinesWithFile(
            expectedLogFile.getAbsolutePath(),
    ...
    protected BuildResult doBuild(final ProjectDescriptor descriptor, CompileScopeTestBuilder scopeBuilder) {
        IncProjectBuilder builder = new IncProjectBuilder(
            descriptor,
        ...
        try {
            ...
            JavaModuleIndex moduleIndex = JpsJavaExtensionService.getInstance()
                .getJavaModuleIndex(descriptor.getProject());
    ...
    public String getAbsolutePath(final String pathRelativeToProjectRoot) {
        return FileUtil.toSystemIndependentName(new File(
